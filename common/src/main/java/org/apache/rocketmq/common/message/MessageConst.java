...
public class MessageConst {
    public static final String PROPERTY_KEYS = "KEYS";//Message索引键，多个用空格隔开，RocketMQ可以根据这些key快速检索到消息
    public static final String PROPERTY_TAGS = "TAGS";//消息TAG ，用于消息过滤
    public static final String PROPERTY_WAIT_STORE_MSG_OK = "WAIT";//消息发送时是否等消息存储完成后返回
